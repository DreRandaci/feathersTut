...
const socket = io();
// Initialize our Feathers client application through Socket.io with hooks and
// authentication.
...
const addMessage = message => {
    // Find the user belonging to this message or use the anonymous user if not
    // found
    const {
        user = {}
    } = message;
...
const showChat = async() => {
    ...
    // Find the latest 25 messages. They will come with the newest first which is
    // why we have to reverse before adding them
